  ...
  #include <prj_gen_xiao_esp32c3.h>
  ...
  // --- specification first to define device config
    ...
    // --- sensors
          ...
          #if (USE_MQTT > OFF)
              #define BME280T_MQTT         "bme280t"
              #define BME280P_MQTT         "bme280p"
              #define BME280H_MQTT         "bme280h"
            #endif
          #ifndef USE_INPUT_CYCLE
              #define USE_INPUT_CYCLE
            #endif
