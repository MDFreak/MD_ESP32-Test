  ...
  // --- project configuration
    ...
    // --- network  components
      ...
      #define USE_RGB_WEBCTRL       OFF
      #define USE_FAN_WEBCTRL       OFF
    // --- memory components
    ...
    // --- system components
      ...
      // usage of peripherals
        ...
        #define USE_PWM_OUT         ((3 * USE_RGBLED_PWM) + USE_OUT_FAN_PWM + USE_OUT_FREQ_PWM + USE_BUZZER_PWM) // max 16
