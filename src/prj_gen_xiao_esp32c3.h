  ...
  // ******************************************
    ...
    // --- system components and devices
      ...
      #define DEV_ADC_INT           OFF//1
      #define DEV_ADC_ADS1115       OFF//1
      #define DEV_ADC_ADS1115_1     OFF//4
    ...
    // --- sensors
      ...
      #define USE_MQ3_ALK_ANA       OFF//1   // ADC or ADS1115
      #define USE_PHOTO_SENS_ANA    OFF//1   // ADC or ADS1115
      #define USE_ACS712_ANA        OFF//1   // only ADS1115
      #define USE_POTI_ANA          OFF//1   // ADC or ADS1115
      #define USE_VCC_ANA           OFF//1   // ADC or ADS1115
      #define USE_ADC1115_I2C       OFF//1   // ADC 4 channels 16Bit
    // --- network  components
      #define USE_WIFI              ON  // ON
      #define USE_NTP_SERVER        ON  // ON
      #define USE_LOCAL_IP          ON  // ON
      #define USE_WEBSERVER         ON  // ON
      #define USE_MQTT              OFF//ON
    // --- memory components
      #define USE_FLASH_MEM         ON
      #define USE_FRAM_I2C          OFF//1   // 1   // [0, 1, ...] limited by I2C channel/addr
