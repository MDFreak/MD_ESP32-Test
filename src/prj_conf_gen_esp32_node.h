#ifndef _PRJ_CONF_GEN_ESP32_NODE_H_
  #define _PRJ_CONF_GEN_ESP32_NODE_H_
    ...
    // --- user output
      // --- display
            ...
            #define USE_STATUS
                ...
                #define OLED1_I2C       MC_UO_OLED_130_AZ  // OLED1 on I2C1
                #if ( USE_OLED_I2C > OFF )
                    #define USE_STATUS1
                    #if !(OLED1_I2C ^ MC_UO_OLED_066_AZ)
                      ...
                      #endif
                    #if ( USE_OLED_I2C > 1 )
                        #define OLED2_I2C             MC_UO_OLED_130_AZ  // OLED1 on I2C1
                        #define USE_STATUS2
                        #if !(OLED2_I2C ^ MC_UO_OLED_066_AZ)
